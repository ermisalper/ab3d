...
Choose the analytics tool only after defining the tracking plan. Key options:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **GA4** | Web analytics, Google ecosystem | ✓ | Google Analytics documentation |
| **Mixpanel** | Product analytics, event tracking | - | Mixpanel documentation |
| **Amplitude** | Product analytics, cohort analysis | - | Amplitude documentation |
| **PostHog** | Open-source analytics, session replay | - | PostHog documentation |
| **Segment** | Customer data platform, routing | - | Segment documentation |
